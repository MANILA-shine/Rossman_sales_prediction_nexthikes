...
model_path = r"C:\Users\manil\ROSSMAN_SALES_PREDICTION_BY_MANILA\saved_models\lstm_model_20230902_114506.pkl"
...
def predict():
    ...
    for i in range(6):
        ...
        predicted_value = model.predict(input_features)[0][0]  # Assuming a single output neuron
